...
#curl -fsSL https://gh-proxy.com/https://github.com/wznpp1/termux_files/raw/main/guangzhou6/gost.sh | bash -x
#/etc/netplan
#netplan apply
...
wget -O /root/app/gost/001.yaml  https://gh-proxy.com/https://github.com/wznpp1/termux_files/raw/main/guangzhou6/001.yaml
